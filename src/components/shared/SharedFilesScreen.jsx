...
function SharedFilesScreen({
  ...
  return (
    <div style={{ padding: "32px 36px", maxWidth: 900 }}>
      <h1 style={{ fontSize: 24, fontWeight: 800, margin: 0, letterSpacing: "-0.02em", color: shellColors.ink }}>Shared Files</h1>
      <p style={{ color: shellColors.inkMuted, fontSize: 14, marginTop: 6, marginBottom: 26, maxWidth: 600 }}>
